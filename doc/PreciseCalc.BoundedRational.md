...
| [operator &gt;=(BoundedRational, BoundedRational)](PreciseCalc.BoundedRational.op_GreaterThanOrEqual(PreciseCalc.BoundedRational,PreciseCalc.BoundedRational).md 'PreciseCalc.BoundedRational.op_GreaterThanOrEqual(PreciseCalc.BoundedRational, PreciseCalc.BoundedRational)') | Returns a value that indicates whether a BoundedRational value is greater than or equal to another BoundedRational value. |
...
| [operator &lt;=(BoundedRational, BoundedRational)](PreciseCalc.BoundedRational.op_LessThanOrEqual(PreciseCalc.BoundedRational,PreciseCalc.BoundedRational).md 'PreciseCalc.BoundedRational.op_LessThanOrEqual(PreciseCalc.BoundedRational, PreciseCalc.BoundedRational)') | Returns a value that indicates whether a BoundedRational value is less than or equal to another BoundedRational value. |
