...
<a name='PreciseCalc.BoundedRational.op_Inequality(PreciseCalc.BoundedRational,PreciseCalc.BoundedRational).left'></a>

`left` [BoundedRational](PreciseCalc.BoundedRational.md 'PreciseCalc.BoundedRational')

<a name='PreciseCalc.BoundedRational.op_Inequality(PreciseCalc.BoundedRational,PreciseCalc.BoundedRational).right'></a>
